...
public class UserCommandServiceImpl implements UserCommandService {
     ...
     * </p>
     * @param command the sign-up command containing the user registration data
    ...
    public Optional<User> handle(SignUpCommand command) {
        ...
        var user = new User(command.firstName(), command.lastName(), command.email(), command.phoneNumber(), hashingService.encode(command.password()), roles);
